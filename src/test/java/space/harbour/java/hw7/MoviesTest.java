...
public class MoviesTest extends TestCase {
    ...
    public void sortByReleaseYear() throws FileNotFoundException {
        ...
        moviesListSorted.get(0).fillDetails(
                "src/main/java/space/harbour/java/hw7/BladeRunner.json");
        moviesListSorted.get(1).fillDetails(
                "src/main/java/space/harbour/java/hw7/TheShawshankRedemption.json");
        moviesListSorted.get(2).fillDetails(
                "src/main/java/space/harbour/java/hw7/MysticRiver.json");
        moviesListSorted.get(3).fillDetails(
                "src/main/java/space/harbour/java/hw7/StayDown.json");
    ...
    public void filterByDirector() throws FileNotFoundException {
        ...
        filterByDirectorResult.get(0).fillDetails(
                "src/main/java/space/harbour/java/hw7/StayDown.json");
        filterByDirectorResult.get(1).fillDetails(
                "src/main/java/space/harbour/java/hw7/TheShawshankRedemption.json");

        assertEquals(filterByDirectorResult,
    ...
    public void filterByActor() throws FileNotFoundException {
        ...
        filterByActorResult.get(0).fillDetails(
                "src/main/java/space/harbour/java/hw7/TheShawshankRedemption.json");
        filterByActorResult.get(1).fillDetails(
                "src/main/java/space/harbour/java/hw7/MysticRiver.json");
    ...
    public void filterByGenre() throws FileNotFoundException {
        ...
        filterByGenreResult.get(0).fillDetails(
                "src/main/java/space/harbour/java/hw7/StayDown.json");
        filterByGenreResult.get(1).fillDetails(
                "src/main/java/space/harbour/java/hw7/TheShawshankRedemption.json");
        filterByGenreResult.get(2).fillDetails(
                "src/main/java/space/harbour/java/hw7/MysticRiver.json");
